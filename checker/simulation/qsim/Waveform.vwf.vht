...
-- *****************************************************************************
-- Generated on "12/15/2020 14:17:01"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          checker_bdf
-- 
...
ENTITY checker_bdf_vhd_vec_tst IS
END checker_bdf_vhd_vec_tst;
ARCHITECTURE checker_bdf_arch OF checker_bdf_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL A : STD_LOGIC_VECTOR(23 DOWNTO 0);
SIGNAL S : STD_LOGIC;
COMPONENT checker_bdf
	PORT (
